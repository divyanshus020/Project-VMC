          ...
          <form className="p-8" onSubmit={handleSubmit}>
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-12 pr-4 py-4 rounded-xl border-2 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.email
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-12 pr-12 py-4 rounded-xl border-2 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.password
                        ? 'border-red-300 bg-red-50 focus:border-red-500'
                        : 'border-slate-200 bg-white hover:border-slate-300 focus:border-blue-500'
                      }`}
              ...
              <button
                type="submit"
                disabled={isLoading}
                className={`w-full py-4 rounded-xl font-bold text-white transition-all duration-200 ${isLoading
