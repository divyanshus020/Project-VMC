...
const ProductInfo = ({ product }) => {
  ...
  const [isCustomWeight, setIsCustomWeight] = useState(false); // Track if weight was manually entered
  ...
  const handleAddToCart = async () => {
    ...
    const cartData = {
      ...
      DieNo: dieNo,
      weight: quantityMode === 'weight' ? parseFloat(customWeight) : weight,
      tunch: tunchNum,
      totalWeight: quantityMode === 'weight' ? parseFloat(customWeight) : weight * quantity,
      isCustomWeight: quantityMode === 'weight',
    };
